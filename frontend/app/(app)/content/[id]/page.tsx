...
export async function generateMetadata(
  ...
  try {
    ...
    const res = await fetch(`${API}/api/content/${params.id}`, { cache: "no-store", signal: controller.signal });
    clearTimeout(timer);
    ...
    return {
      ...
      alternates: SITE ? {
        types: {
          "application/json+oembed": `${SITE}/api/oembed?url=${encodeURIComponent(`${SITE}/content/${params.id}`)}&format=json`,
        },
      } : undefined,
    };
  } catch {
