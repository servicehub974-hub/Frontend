...
import { Shield, Plus, ToggleLeft, ToggleRight, Gem, Crown, Check, X } from "lucide-react";
...
export default function AdminPage() {
  ...
  const savePay = async () => {
    try { await api("/api/admin/payment-settings", { method: "PUT", json: pay }); qc.invalidateQueries({ queryKey: ["admin-pay"] }); qc.invalidateQueries({ queryKey: ["payment-settings"] }); }
    catch (e) { setErr(e instanceof Error ? e.message : "Failed"); }
  };
