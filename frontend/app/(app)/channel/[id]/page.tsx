...
import { CheckCircle, X, Share2, Flag, Users, Video, Eye, Calendar, Globe, Settings } from "lucide-react";
...
type Tab = "videos" | "shorts" | "photos" | "about";
...
export default function ChannelPage({ params }: { params: { id: string } }) {
  ...
  const tabs: Tab[] = ["videos", "shorts", "photos", "about"];

  return (
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
      {/* Banner (adjustable like YouTube via object-cover) */}
      <div className="relative h-28 w-full overflow-hidden rounded-2xl bg-gradient-to-r from-violet-900/40 to-cyan-900/30 sm:h-44">
        {p.cover_url && (
