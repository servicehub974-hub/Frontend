...
function PostModal({ post, onClose }: { post: Post; onClose: () => void }) {
  ...
  return (
    <>
      <div className="fixed inset-0 z-[99] bg-black/50 backdrop-blur-lg" onClick={onClose} />
      <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto p-4" onClick={onClose}>
