...
export function ContentCard({ item, index }: { item: ContentItem; index: number }) {
  ...
  return (
    ...
    >
      <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-white/5 bg-[#111] transition-all duration-500 group-hover:border-white/20 group-hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.8)]">
